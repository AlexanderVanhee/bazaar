...
typedef enum
{
  ...
  BZ_CATEGORY_FLAGS_HEALTH           = 1 << 10,
  BZ_CATEGORY_FLAGS_TRENDING         = 1 << 11,
  BZ_CATEGORY_FLAGS_POPULAR          = 1 << 12,
  BZ_CATEGORY_FLAGS_RECENTLY_ADDED   = 1 << 13,
  BZ_CATEGORY_FLAGS_RECENTLY_UPDATED = 1 << 14,
  BZ_CATEGORY_FLAGS_MOBILE           = 1 << 15,
  BZ_CATEGORY_FLAGS_ADWAITA          = 1 << 16,
  BZ_CATEGORY_FLAGS_KDE              = 1 << 17,
} BzCategoryFlags;
